...
namespace GroupService.API.Jobs
{
    public class DeleteUserJob(IConfiguration configuration, IServiceProvider serviceProvider) : BackgroundService
    {
        ...
        {
            var queueName = configuration["RabbitMQ:DeleteUserQueue"] ?? "deleteUser";
