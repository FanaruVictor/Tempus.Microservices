...
{
    public class DeleteCategoryJob(IConfiguration configuration, IServiceProvider serviceProvider) : BackgroundService
    {
        ...
        {
            var queueName = configuration["RabbitMQ:DeleteCategoryQueue"] ?? "deleteCategory";
